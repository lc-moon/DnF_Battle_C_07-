...
<body>
    ...
    %>
                    ...
                    <div style="background-color: #fafafa; padding: 12px; border: 1px dashed #333; display: inline-block; margin-top: 10px;">
                        <strong>🎉 전리품 발견!</strong> 
                        <a href="Add_Item_UI.jsp" style="color: #0066cc; font-weight: bold; text-decoration: none;">[몬스터가 드롭한 아이템 획득하러 가기 ➔]</a>
                    </div>
                    <br>
    <%
                }
