...
<%
    // 💡 [중요] 브라우저에서 넘어오는 모든 입력값(hero, 전사 등)의 한글 깨짐을 방지합니다.
...
<body>
    ...
    <%
        ...
        if("create".equals(action)) {
            ...
            if(playerId != null && charName != null && job != null && levelStr != null) {
                ...
                // 이제 깨지지 않은 깨끗한 데이터가 전투 클래스로 전달됩니다!
    ...
    %>
                    ...
                    <br>
                    <a href="Attack_Monster_UI.jsp"><button type="button" style="padding:5px 10px; font-weight:bold;">몬스터 공격 화면으로 이동 ➔</button></a>
    <%
                } else {
    %>
